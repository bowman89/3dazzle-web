...
function HeroSection() {
  return (
    <section className="text-[#201F21] body-font">
      <div className="container mx-auto flex px-5 py-24 mt-24 mb-24 md:flex-row flex-col items-center gap-12">
        {/* Tekstkolonne */}
        <div className="flex-1 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-[#201F21]">
          ...
          <button className="relative inline-flex text-[#201F21] bg-[#DED600] border-0 py-2 px-6 focus:outline-none rounded text-lg font-bold group overflow-hidden transition-shadow duration-200 hover:shadow-lg cursor-pointer">
            <span className="relative z-10">Se udvalget!</span>
            <span
              className="absolute left-6 right-6 bottom-2 h-px bg-[#201F21] scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left rounded"
              aria-hidden="true"
            />
          </button>
          </div>
